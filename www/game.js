...
__sprite_init__(this, sprite_24, 120, 40, 0, 0, 'Box', 60, 0, 120, 0, 40, ['img/sprite_24_0.png','img/sprite_24_1.png']);
}; var sprite_24 = new __sprite_24();

function __sprite_25() { 
__sprite_init__(this, sprite_25, 120, 40, 60, 20, 'Box', 60, 0, 120, 0, 40, ['img/sprite_25_0.png','img/sprite_25_1.png']);
}; var sprite_25 = new __sprite_25();

function __sprite_26() { 
__sprite_init__(this, sprite_26, 80, 80, 40, 40, 'Box', 40, 0, 80, 0, 80, ['img/sprite_26_0.png','img/sprite_26_1.png']);
}; var sprite_26 = new __sprite_26();

function __sprite_27() { 
__sprite_init__(this, sprite_27, 120, 40, 60, 20, 'Box', 60, 0, 120, 0, 40, ['img/sprite_27_0.png','img/sprite_27_1.png']);
}; var sprite_27 = new __sprite_27();

function __sprite_28() { 
__sprite_init__(this, sprite_28, 120, 40, 60, 20, 'Box', 60, 0, 120, 0, 40, ['img/sprite_28_0.png','img/sprite_28_1.png']);
}; var sprite_28 = new __sprite_28();

function __spr_top() { 
__sprite_init__(this, spr_top, 180, 40, 90, 20, 'Box', 90, 0, 180, 0, 40, ['img/spr_top_0.png','img/spr_top_1.png']);
}; var spr_top = new __spr_top();

function __spr_effects() { 
__sprite_init__(this, spr_effects, 160, 160, 80, 80, 'Box', 80, 0, 160, 0, 160, ['img/spr_effects_0.png','img/spr_effects_1.png','img/spr_effects_2.png','img/spr_effects_3.png']);
}; var spr_effects = new __spr_effects();

function __spr_down_a() { 
__sprite_init__(this, spr_down_a, 180, 40, 90, 20, 'Box', 90, 0, 180, 0, 40, ['img/spr_down_a_0.png','img/spr_down_a_1.png']);
}; var spr_down_a = new __spr_down_a();

function __spr_down_b() { 
__sprite_init__(this, spr_down_b, 180, 40, 90, 20, 'Box', 90, 0, 180, 0, 40, ['img/spr_down_b_0.png','img/spr_down_b_1.png']);
}; var spr_down_b = new __spr_down_b();

function __spr_top_b() { 
__sprite_init__(this, spr_top_b, 180, 40, 90, 20, 'Box', 90, 0, 180, 0, 40, ['img/spr_top_b_0.png','img/spr_top_b_1.png']);
}; var spr_top_b = new __spr_top_b();
 ...
 ***********************************************************************/
function __snd_51() { 
__audio_init__(this, snd_51, 'aud/kaifuku0010.wav', '', '');
}; var snd_51 = new __snd_51();

function __snd_52() { 
__audio_init__(this, snd_52, 'aud/dageki0003.wav', '', '');
}; var snd_52 = new __snd_52();

function __snd_53() { 
__audio_init__(this, snd_53, 'aud/showmetu1.wav', '', '');
}; var snd_53 = new __snd_53();
 ...
 ***********************************************************************/
function __font_a() { 
__font_init__(this, font_a, 'Arial', 16, 0, 0)}; var font_a = new __font_a();
 ...
 * OBJECTS
 ***********************************************************************/
function __show_HackMD() {
__instance_init__(this, show_HackMD, null, 1, 0, sprite_24, 1, 0);
this.on_creation = on_creation_i;
this.on_destroy = on_destroy_i;
this.on_step = function() {
with(this) {
image_index = 1 ;
if(mouse_check_pressed() && position_meeting(mouse_x, mouse_y, show_HackMD)) {
image_index = 2;
sound_play(snd_51);
open_hackmd();
};
...
}; var show_HackMD = new __show_HackMD();

function __obj_draw() {
__instance_init__(this, obj_draw, null, 1, 0, null, 1, 1);
this.on_creation = on_creation_i;
this.on_destroy = on_destroy_i;
...
__handle_sprite__(this);
with(this) {
draw_set_font(font_a)
draw_text(x-54,y-10,'Show HackMD')
}
}
};
}; var obj_draw = new __obj_draw();

function __show_Gist() {
__instance_init__(this, show_Gist, null, 1, 0, sprite_25, 1, 2);
this.on_creation = on_creation_i;
this.on_destroy = on_destroy_i;
this.on_step = function() {
with(this) {
image_index = 1 ;
if(mouse_check_pressed() && position_meeting(mouse_x, mouse_y, show_Gist)) {
image_index = 2;
sound_play(snd_51);
open_gist();
};
...
this.on_animationend = on_animationend_i;
this.on_draw = on_draw_i;
}; var show_Gist = new __show_Gist();

function __obj_draw_2() {
__instance_init__(this, obj_draw_2, null, 1, 0, null, 1, 6);
this.on_creation = on_creation_i;
this.on_destroy = on_destroy_i;
this.on_step = on_step_i;
this.on_end_step = on_end_step_i;
...
with(this) {
draw_set_font(font_a)
draw_text(x-36,y-10,'Show Gist')
}
}
};
}; var obj_draw_2 = new __obj_draw_2();

function __obj_rogo() {
__instance_init__(this, obj_rogo, null, 1, 0, sprite_26, 1, 8);
this.on_creation = on_creation_i;
...
with(this) {
image_index = 1 ;
if(mouse_check_pressed() && position_meeting(mouse_x, mouse_y, obj_rogo)) {
dageki = 1;
};
...
dageki = 0;
dageking += 1;
instance_create(x,y,obj_effects);
};
...
this.on_animationend = on_animationend_i;
this.on_draw = on_draw_i;
}; var obj_rogo = new __obj_rogo();

function __show_GitLab() {
__instance_init__(this, show_GitLab, null, 1, 0, sprite_27, 1, 11);
this.on_creation = on_creation_i;
this.on_destroy = on_destroy_i;
this.on_step = function() {
with(this) {
image_index = 1 ;
if(mouse_check_pressed() && position_meeting(mouse_x, mouse_y, show_GitLab)) {
image_index = 2;
sound_play(snd_51);
open_gitlab();
};
...
this.on_animationend = on_animationend_i;
this.on_draw = on_draw_i;
}; var show_GitLab = new __show_GitLab();

function __show_CodePen() {
__instance_init__(this, show_CodePen, null, 1, 0, sprite_28, 1, 12);
this.on_creation = on_creation_i;
this.on_destroy = on_destroy_i;
this.on_step = function() {
with(this) {
image_index = 1 ;
if(mouse_check_pressed() && position_meeting(mouse_x, mouse_y, show_CodePen)) {
image_index = 2;
sound_play(snd_51);
open_codepen();
};
...
this.on_animationend = on_animationend_i;
this.on_draw = on_draw_i;
}; var show_CodePen = new __show_CodePen();

function __obj_draw_3() {
__instance_init__(this, obj_draw_3, null, 1, 0, null, 1, 13);
this.on_creation = on_creation_i;
this.on_destroy = on_destroy_i;
this.on_step = on_step_i;
this.on_end_step = on_end_step_i;
...
with(this) {
draw_set_font(font_a)
draw_text(x-50,y-10,'Show GitLab')
}
}
};
}; var obj_draw_3 = new __obj_draw_3();

function __obj_draw_4() {
__instance_init__(this, obj_draw_4, null, 1, 0, null, 1, 14);
this.on_creation = on_creation_i;
this.on_destroy = on_destroy_i;
this.on_step = on_step_i;
this.on_end_step = on_end_step_i;
...
with(this) {
draw_set_font(font_a)
draw_text(x-56,y-10,'Show CodePen')
}
}
};
}; var obj_draw_4 = new __obj_draw_4();

function __obj_top_left() {
__instance_init__(this, obj_top_left, null, 1, 0, spr_top, 1, 19);
this.on_creation = on_creation_i;
this.on_destroy = on_destroy_i;
this.on_step = function() {
with(this) {
image_index = 1 ;
if(mouse_check_pressed() && position_meeting(mouse_x, mouse_y, obj_top_left)) {
image_index = 2;
sound_play(snd_51);
open_link_bi64();
};
...
this.on_animationend = on_animationend_i;
this.on_draw = on_draw_i;
}; var obj_top_left = new __obj_top_left();

function __obj_top_right() {
__instance_init__(this, obj_top_right, null, 1, 0, spr_top_b, 1, 21);
this.on_creation = on_creation_i;
this.on_destroy = on_destroy_i;
this.on_step = function() {
with(this) {
image_index = 1 ;
if(mouse_check_pressed() && position_meeting(mouse_x, mouse_y, obj_top_right)) {
image_index = 2;
sound_play(snd_51);
open_link();
};
...
this.on_animationend = on_animationend_i;
this.on_draw = on_draw_i;
}; var obj_top_right = new __obj_top_right();

function __obj_effects() {
__instance_init__(this, obj_effects, null, 1, 10, spr_effects, 1, 23);
this.on_creation = on_creation_i;
this.on_destroy = on_destroy_i;
this.on_step = on_step_i;
this.on_end_step = on_end_step_i;
...
this.on_draw = on_draw_i;
}; var obj_effects = new __obj_effects();

function __obj_down_left() {
__instance_init__(this, obj_down_left, null, 1, 0, spr_down_b, 1, 24);
this.on_creation = on_creation_i;
this.on_destroy = on_destroy_i;
this.on_step = function() {
with(this) {
image_index = 1 ;
if(mouse_check_pressed() && position_meeting(mouse_x, mouse_y, obj_down_left)) {
image_index = 2;
sound_play(snd_51);
open_link_clip();
};
...
this.on_animationend = on_animationend_i;
this.on_draw = on_draw_i;
}; var obj_down_left = new __obj_down_left();

function __obj_down_right() {
__instance_init__(this, obj_down_right, null, 1, 0, spr_down_a, 1, 26);
this.on_creation = on_creation_i;
this.on_destroy = on_destroy_i;
this.on_step = function() {
with(this) {
image_index = 1 ;
if(mouse_check_pressed() && position_meeting(mouse_x, mouse_y, obj_down_right)) {
image_index = 2;
sound_play(snd_51);
open_link_clip_b();
};
...
this.on_animationend = on_animationend_i;
this.on_draw = on_draw_i;
}; var obj_down_right = new __obj_down_right();
...
this.objects = [
[{o:show_HackMD, x:40, y:140}],
[{o:show_Gist, x:260, y:160}],
[{o:obj_draw, x:100, y:120}],
[{o:obj_draw_2, x:260, y:120}],
[{o:obj_rogo, x:180, y:400}],
[{o:obj_rogo, x:180, y:400}],
[{o:show_GitLab, x:100, y:280}],
[{o:show_CodePen, x:260, y:280}],
[{o:obj_draw_3, x:100, y:240}],
[{o:obj_draw_4, x:260, y:240}],
[{o:obj_top_left, x:90, y:20}],
[{o:obj_top_right, x:270, y:20}],
[{o:obj_down_left, x:90, y:500}],
[{o:obj_down_right, x:270, y:500}]];
this.start = function() {
__room_start__(this, stg_001, 360, 640, 30, 74, 74, 74, null, 0, 0, 0, 360, 640, null, 50, 50);
};
}
var stg_001 = new __stg_001();
tu_scenes.push(stg_001);
tu_room_to_go = stg_001;
...
windowObjectReference = window.open("./Clip_3.html", "_self");
}
function open_link_bi64() { 
var windowObjectReference;
var windowFeatures = "menubar=yes,location=yes,resizable=yes,scrollbars=yes,status=yes";

windowObjectReference = window.open("./BI64.html", "_self");
}
function local_save() { 
var fm_text = document.getElementById("inputreferer").value;
sound_play(snd_51);
save_web_data("loca_a1",fm_text);
}
function local_load() { 
//var referer = localStorage.getItem('boowy');
var referer = load_web_data("loca_a1")
//document.getElementById("thisreferer").innerHTML = referer;
document.getElementById("inputreferer").value = referer;
}
function open_link_clip() { 
var windowObjectReference;
var windowFeatures = "menubar=yes,location=yes,resizable=yes,scrollbars=yes,status=yes";

windowObjectReference = window.open("./Clip.html", "_self");
}
function open_link_clip_b() { 
var windowObjectReference;
var windowFeatures = "menubar=yes,location=yes,resizable=yes,scrollbars=yes,status=yes";

windowObjectReference = window.open("./Clip_2.html", "_self");
}
